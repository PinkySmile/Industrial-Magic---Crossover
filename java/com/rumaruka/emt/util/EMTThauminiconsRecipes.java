...
public class EMTThauminiconsRecipes {
    ...
    public static void  setup() {
        ...
        ThaumcraftApi.addArcaneCraftingRecipe(new ResourceLocation("EMT.electricgoggles"), new ShapedArcaneRecipe(defaultGroup,"EMT.ARMORS_G",45, new AspectList().add(Aspect.AIR,10).add(Aspect.ORDER,10).add(Aspect.WATER,10),new ItemStack(EMTItems.electricgoggles),
                new Object[] {
                        " h ",
                        "rgr",
                        "cbc",
