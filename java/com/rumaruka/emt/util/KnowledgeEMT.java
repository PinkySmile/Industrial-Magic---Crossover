...
public class KnowledgeEMT  {
    ...
    private static void $init()
    {
        ...
        new REB()
            .setBaseInfo("EMT.WINGS_B", "wings_b", -2, 0, new ItemStack(EMTItems.materials_feathergluedcardboardwing))
            .setStages(
                new RSB()
                    .setText("research_stage." + emt.MOD_ID + ":wings_b.1")
                    ...
                    .build(),
                new RSB()
                    .setText("research_stage." + emt.MOD_ID + ":wings_b.2")
                    .setRecipes("emt:materials_feathergluedcardboardwing","EMT.TaintFeather")
                    .build()
            )
            .setParents("EMT.FIRST")
            .buildAndRegister();
        new REB()
            .setBaseInfo("EMT.WINGS_B", "wings_b", -2, 0, new ItemStack(EMTItems.materials_feathergluedcardboardwing))
            .setStages(
        ...
        new REB()
            .setBaseInfo("EMT.WINGS", "wings", -3, 0, new ItemStack(EMTItems.featherwing))
            .setMeta(ResearchEntry.EnumResearchMeta.HIDDEN, ResearchEntry.EnumResearchMeta.HEX)
            .setStages(
                new RSB()
                    .setText("research_stage." + emt.MOD_ID + ":wings.1")
                    .setKnow(new ResearchStage.Knowledge(IPlayerKnowledge.EnumKnowledgeType.OBSERVATION, ResearchCategories.getResearchCategory("ARTIFICE"), 1))
                    .build(),
                new RSB()
                    .setText("research_stage." + emt.MOD_ID + ":wings.2")
                    .setRecipes("EMT.nanoW","EMT.qW")
                    .build()
            )
